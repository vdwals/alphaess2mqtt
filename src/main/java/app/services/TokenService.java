...
public class TokenService {
    ...
    public String getToken() {
        ...
        if (currentToken == null) {
            ...
            Post loginPost = Http
                    .post(loginJob.getUrl(), JsonHelper.toJsonString(settings))
            ...
            try {
                ...
                LocalDateTime expirationTime = LocalDateTime
                        .parse(tokenDto.getTokenCreationTime(), formatter)
                ...
                // Save new token.
                currentToken = AlphaEssToken.create(tokenDto.getAccessToken(), expirationTime, tokenDto.getRefreshTokenKey());
