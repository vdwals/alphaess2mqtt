...
public class InverterDeviceService extends DeviceService {
  ...
  public void mapValues(SummeryDto data) {
    ...
    getDevice()
        .updateValue(
            selfConsumption.getObjectId(), getScaledValue(data.getEselfConsumption() * 100));
    getDevice()
        .updateValue(
            selfSufficiency.getObjectId(), getScaledValue(data.getEselfSufficiency() * 100));
